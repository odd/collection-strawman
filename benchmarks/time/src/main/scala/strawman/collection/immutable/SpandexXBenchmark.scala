...
class SpandexXBenchmark {

  @Param(scala.Array("0"/*, "1", "2", "3", "4"*/, "7", "8"/*, "15", "16"*/, "17", "39", "282", "73121"/*, "7312102"*/))
  var size: Int = _

  var xs: SpandexX[Long] = _
  var xss: scala.Array[SpandexX[Long]] = _
  var randomIndices: scala.Array[Int] = _

  @Setup(Level.Trial)
  def initData(): Unit = {
    def freshCollection() = SpandexX((1 to size).map(_.toLong): _*)
    xs = freshCollection()
